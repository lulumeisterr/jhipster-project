  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jayjayApplicationApp.sensor.home.createOrEditLabel" data-cy="SensorCreateUpdateHeading">
            <Translate contentKey="jayjayApplicationApp.sensor.home.createOrEditLabel">Create or edit a Sensor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : sensorEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="variableLabel" for="sensor-variable">
                  <Translate contentKey="jayjayApplicationApp.sensor.variable">Variable</Translate>
                </Label>
                <AvField id="sensor-variable" data-cy="variable" type="text" name="variable" />
              </AvGroup>
              <AvGroup>
                <Label id="unitLabel" for="sensor-unit">
                  <Translate contentKey="jayjayApplicationApp.sensor.unit">Unit</Translate>
                </Label>
                <AvField id="sensor-unit" data-cy="unit" type="text" name="unit" />
              </AvGroup>
              <AvGroup>
                <Label id="valueLabel" for="sensor-value">
                  <Translate contentKey="jayjayApplicationApp.sensor.value">Value</Translate>
                </Label>
