  ...
  return (
    <div>
      <h2 id="sensor-heading" data-cy="SensorHeading">
        <Translate contentKey="jayjayApplicationApp.sensor.home.title">Sensors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jayjayApplicationApp.sensor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jayjayApplicationApp.sensor.home.createLabel">Create new Sensor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {sensorList && sensorList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jayjayApplicationApp.sensor.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('variable')}>
                  <Translate contentKey="jayjayApplicationApp.sensor.variable">Variable</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('unit')}>
                  <Translate contentKey="jayjayApplicationApp.sensor.unit">Unit</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('value')}>
                  <Translate contentKey="jayjayApplicationApp.sensor.value">Value</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jayjayApplicationApp.sensor.home.notFound">No Sensors found</Translate>
            </div>
          )
        )}
      </div>
