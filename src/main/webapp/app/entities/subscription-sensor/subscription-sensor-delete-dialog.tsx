...
export const SubscriptionSensorDeleteDialog = (props: ISubscriptionSensorDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jayjayApplicationApp.subscriptionSensor.delete.question">
        <Translate contentKey="jayjayApplicationApp.subscriptionSensor.delete.question" interpolate={{ id: subscriptionSensorEntity.id }}>
