  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sensorsApp.subscriptionSensor.home.createOrEditLabel" data-cy="SubscriptionSensorCreateUpdateHeading">
            <Translate contentKey="sensorsApp.subscriptionSensor.home.createOrEditLabel">Create or edit a SubscriptionSensor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
