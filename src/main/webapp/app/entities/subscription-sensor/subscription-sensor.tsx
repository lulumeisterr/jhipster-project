  ...
  return (
    <div>
      <h2 id="subscription-sensor-heading" data-cy="SubscriptionSensorHeading">
        <Translate contentKey="jayjayApplicationApp.subscriptionSensor.home.title">Subscription Sensors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jayjayApplicationApp.subscriptionSensor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jayjayApplicationApp.subscriptionSensor.home.createLabel">Create new Subscription Sensor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {subscriptionSensorList && subscriptionSensorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jayjayApplicationApp.subscriptionSensor.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jayjayApplicationApp.subscriptionSensor.home.notFound">No Subscription Sensors found</Translate>
            </div>
          )
        )}
      </div>
